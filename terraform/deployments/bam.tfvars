prefix       = "bam"
project_root = "../projects/26-beehive-apiary-monitoring"

table_name = "bam-readings"
queue_name = "bam-apiary-agg"

processor_lambda_name   = "bam-processor"
...
dashboard_lambda_name   = "bam-dashboard-api"
dashboard_build_command = "cd backend/dashboard && npm ci --omit=dev --silent && rm -f lambda.zip && zip -qr lambda.zip lambdaHandler.js awsClients.js readingsStore.js pipelineStatus.js thresholdsProxy.js colonyNarrative.js package.json node_modules"
