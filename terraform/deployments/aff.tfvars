prefix       = "aff"
project_root = "../projects/09-aquaculture-fish-farm"

table_name = "aff-readings"
queue_name = "aff-pond-agg"

processor_lambda_name   = "aff-processor"
...
processor_handler       = "com.fec.aquaculture.processor.PondHandler::handleRequest"
processor_runtime       = "java17"

dashboard_lambda_name   = "aff-dashboard-api"
...
dashboard_handler       = "com.fec.aquaculture.dashboard.PondDashboardLambda::handleRequest"
