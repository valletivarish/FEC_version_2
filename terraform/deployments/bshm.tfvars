prefix       = "bshm"
project_root = "../projects/21-bridge-structural-health"

table_name = "bshm-readings"
queue_name = "bshm-span-agg"

processor_lambda_name   = "bshm-processor"
...
dashboard_lambda_name   = "bshm-dashboard-api"
dashboard_build_command = "cd backend/dashboard && rm -rf build lambda.zip && pip install -r requirements.txt -t build --quiet && cp lambda_handler.py data_access.py scoring.py thresholds_proxy.py build/ && cd build && zip -qr ../lambda.zip . && cd .."
