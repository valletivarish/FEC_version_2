prefix       = "owf"
project_root = "../projects/06-offshore-wind-farm"

table_name = "owf-readings"
queue_name = "owf-turbine-agg"

processor_lambda_name   = "owf-processor"
...
dashboard_lambda_name   = "owf-dashboard-api"
dashboard_build_command = "cd backend/dashboard && npm ci --omit=dev --silent && rm -f lambda.zip && zip -qr lambda.zip lambdaHandler.js server.js awsClients.js readingsStore.js pipelineStatus.js routes package.json node_modules"
