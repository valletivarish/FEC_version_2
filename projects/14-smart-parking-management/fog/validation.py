"""Input validation for POST /ingest, isolated from app.py so it is unit-testable without sockets or the buffer."""


def validate_batch(payload):
    """Return an error string if payload is not a well-formed ingest batch, or None if acceptable; never raises."""
