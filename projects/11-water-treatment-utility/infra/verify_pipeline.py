...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4576")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "wtu-readings")

SENSOR_TYPES = ["turbidity_ntu", "ph_level", "chlorine_ppm", "flow_rate_lps", "pressure_bar"]
