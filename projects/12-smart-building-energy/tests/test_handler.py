...
MESSAGE = {
    ...
    "window_end": "e",
    "count": 3,
    "min": 600.0, "max": 700.0, "avg": 650.0, "latest": 690.0,
...
class TestLambdaHandler:
    def test_writes_each_record_to_the_table(self, monkeypatch):
        ...
        assert fake_table.items[0]["sensor_type"] == "co2_ppm"
        assert fake_table.items[0]["sort_key"] == "e#floor-1"
        assert fake_table.items[0]["avg"] == 650.0
