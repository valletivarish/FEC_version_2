...
EXPECTED_SENSOR_TYPES = {
    "energy_consumption_kw", "co2_ppm", "occupancy_count", "hvac_temp_c", "water_usage_lpm",
}
...
def make_agent(monkeypatch, sensor_type="energy_consumption_kw", site_id="floor-1"):
    ...
    return sensor.BuildingSensorAgent()
