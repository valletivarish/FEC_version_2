...
QUEUE_NAME = os.getenv("SQS_QUEUE_NAME", "fsc-metrics-agg")

# Synthetic type names distinct from the 5 real metrics, so burst traffic
...
def sample_message(i):
    metric = LOAD_TYPES[i % len(LOAD_TYPES)]
