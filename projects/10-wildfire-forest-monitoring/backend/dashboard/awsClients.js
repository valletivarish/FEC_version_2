...
function baseConfig() {
  ...
  // the signal for static emulator credentials. Real Lambda injects
  // AWS_ACCESS_KEY_ID for its own execution role, so gating on that
  // variable would clobber the role's session credentials in production.
