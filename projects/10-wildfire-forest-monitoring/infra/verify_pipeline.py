...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4575")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "wfm-readings")

SENSOR_TYPES = ["temperature_c", "humidity_pct", "smoke_density_ppm", "wind_speed_kmh", "soil_moisture_pct"]
