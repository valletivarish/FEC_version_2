...
def test_swap_is_a_reference_swap_not_a_copy():
    ...
    # After one swap, the object that used to be `active` is now `flushing`
    # (and vice versa) -- proves swap() re-points the two names rather than
    # allocating fresh dicts.
