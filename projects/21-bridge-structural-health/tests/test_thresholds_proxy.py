...
thresholds_proxy = load_module("bshm_thresholds_proxy", "backend/dashboard/thresholds_proxy.py")


class ThresholdsHandler(BaseHTTPRequestHandler):
    payload = {"strain_microstrain": [{"field": "avg", "op": "avg_gt", "limit": 1200, "key": "structural_stress_warning"}]}
