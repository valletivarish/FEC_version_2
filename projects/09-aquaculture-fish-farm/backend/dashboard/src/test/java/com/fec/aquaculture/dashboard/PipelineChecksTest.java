...
class PipelineChecksTest {
    ...
    @Test
    void itemCountSumsAcrossEveryScanPageUntilPaginationIsExhausted() {
        FakeDynamoDbClient dynamo = new FakeDynamoDbClient(Map.of(), List.of(500, 500, 214));
        assertEquals(1214, new PipelineChecks().itemCount(dynamo, "aff-readings"));
    }
}
