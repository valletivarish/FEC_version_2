...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4574")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "aff-readings")

SENSOR_TYPES = ["water_temp_c", "dissolved_oxygen_mgl", "ph_level", "ammonia_ppm", "feed_dispensed_g"]
