...
// network (http://fog:8000/health), which is only reachable because
// infra/docker-compose.yml sets LAMBDA_DOCKER_NETWORK on the LocalStack
// service so Lambda executor containers join the same network as fog.
