...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4580")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "dce-readings")

SENSOR_TYPES = ["temperature_c", "humidity_pct", "airflow_cfm", "power_load_kw", "dust_density_ugm3"]
