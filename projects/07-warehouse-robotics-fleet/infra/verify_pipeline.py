...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4572")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "wrf-readings")

SENSOR_TYPES = ["battery_level_pct", "payload_kg", "motor_temp_c", "position_drift_cm", "task_queue_depth"]
