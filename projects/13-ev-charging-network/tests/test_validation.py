...
class TestValidateBatch:
    ...
    def test_accepts_batch_missing_optional_site_id_and_unit(self):
        payload = {"sensor_type": "charging_current_a", "readings": [{"ts": "t0", "value": 1.0}]}
    ...
    def test_rejects_reading_with_non_numeric_value(self):
        assert validation.validate_batch(valid_payload(readings=[{"ts": "t0", "value": "hot"}])) is not None
    ...
    def test_rejects_reading_that_is_not_an_object(self):
