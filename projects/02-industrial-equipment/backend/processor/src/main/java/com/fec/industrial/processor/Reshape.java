...
public class Reshape {
    ...
    public static Map<String, AttributeValue> toDynamoItem(String messageBody) throws Exception {
        ...
        // window_end leads the sort key so native key order is already chronological; site_id only disambiguates ties.
