...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4571")
REGION = os.getenv("AWS_REGION", "eu-west-1")
QUEUE_NAME = os.getenv("SQS_QUEUE_NAME", "owf-turbine-agg")

# Synthetic type names distinct from the 5 real sensors, so burst traffic never
# lands in the DynamoDB partitions the live dashboard reads from.
