...
ENDPOINT = os.getenv("AWS_ENDPOINT_URL", "http://localhost:4573")
REGION = os.getenv("AWS_REGION", "eu-west-1")
TABLE_NAME = os.getenv("TABLE_NAME", "rfi-readings")

SENSOR_TYPES = ["footfall_count", "shelf_stock_pct", "fridge_temp_c", "queue_length", "energy_draw_kw"]
